...
def main():
    ...
    # list_ss = ["NC(=O)c1cccc(OC2CC3CCC(C2)N3C2(c3ccccc3)CC2)c1","CN(C)C(CNC(CN)Cc1ccc(O)cc1)Cc1ccc(O)cc1"] #3.85 e
    # 1.73 prediction = predictor.predict(list_ss,utils) print(prediction)
